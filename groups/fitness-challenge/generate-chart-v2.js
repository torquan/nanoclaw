...
function drawChart(name, cals, avg, weights, calTarget, weightRange, accentColor, accentLight, accentDark, filename) {
  const W = 1000, H = 520;
  ...
  const margin = { top: 65, right: 70, bottom: 60, left: 65 };
  ...
  ctx.fillText('Weight & Daily Calories  •  Mar 14 – Apr 6, 2026', margin.left, 50);
  ...
  ctx.font = '11px sans-serif';
  const wStep = weights.length > 4 ? 1 : 0.5;
...
drawChart('Luis', luisCals, luisAvg, luisWeights, 2616,
  ...
  '/workspace/group/chart-luis.png');

drawChart('Miley', mileyCals, mileyAvg, mileyWeights, 1800,
  [49.5, 52.5], '#f54284', 'rgba(245,66,132,0.55)', 'rgba(245,66,132,0.08)',
  '/workspace/group/chart-miley.png');
