...
// Lazy-loaded proto — Baileys doesn't reliably export it as ESM, and
// createRequire breaks in test environments with top-level await.
let _proto: any;
    ...
    this.sock = makeWASocket({
      ...
      getMessage: async (key: WAMessageKey) => {
        ...
        if (content) {
          ...
          return p.Message.fromObject({ conversation: content });
        }
